...
def safe_select(session, sql, retries=3):
            ...
            for compressor in compressors:
                ...
                for encoding in encodings:
                    ...
                    for _ in range(REPEAT_TIME):
                        ...
                        time_start = time.time()
                        session_data_set = safe_select(session, "select s_0 from root.test.t1")
                        if session_data_set is None:
                            print("SKIPPED")
                            print(path,compressor,encoding)
                            continue
                        time_end = time.time()
